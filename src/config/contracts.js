export const REAL_ESTATE_REPOSITORY = {
  ADDRESS: '0x029F2DC5e17dBDC53dBF296B2743D1d2132375b7',
  ABI: [
    {
      "inputs": [],
...
export const REAL_ESTATE_PHOTOS = {
  ADDRESS: '0xf524423A7DE454420B97ECCb1A0d6e8cD4a03884',
  ABI: [
    {
      "anonymous": false,
      "inputs": [
...
export const REAL_ESTATE_SELLING_FACTORY = {
  ADDRESS: '0x10A6d5c39685006069C2C9768B6E1fd0910daC4b',
  ABI: [
    {
      "inputs": [
        {
