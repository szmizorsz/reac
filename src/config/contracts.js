export const REAC_ACCESS_CONTROL = {
  ADDRESS: '0xe59fDa0914cdC1bd62E94df0BC4Df82974807910',
  ABI: [
    {
      "inputs": [],
...
export const REAL_ESTATE_REPOSITORY = {
  ADDRESS: '0x509d883622893A174B13e131f339a94B2Da362D1',
  ABI: [
    {
      "inputs": [
        {
...
export const REAL_ESTATE_PHOTOS = {
  ADDRESS: '0x9995F98Da6aC8974f1e9fb22a8aa8566A9b71Dc1',
  ABI: [
    {
      "inputs": [
        {
...
export const REAL_ESTATE_SELLING_FACTORY = {
  ADDRESS: '0xc5D6179f10005c015045c4CD007F4b8A646Fde6A',
  ABI: [
    {
      "inputs": [
        {
...
export const MORTGAGE_LIQUIDITY_POOL = {
  ADDRESS: '0x74090909b648F2a3FB2D56A229B8E86AA4bd4844',
  ABI: [
    {
      "inputs": [
        {
